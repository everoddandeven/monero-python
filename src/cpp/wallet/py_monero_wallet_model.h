...
public:
  ...
  PyMoneroMultisigTxDataParams(const std::string& multisig_tx_hex): m_multisig_tx_hex(multisig_tx_hex) { }
...
public:
  ...
  PyMoneroDecodedAddress(const std::string& address, PyMoneroAddressType address_type, monero::monero_network_type network_type);
};

struct PyMoneroAccountTag : public monero::serializable_struct {
public:
  ...
  PyMoneroAccountTag() { }
  PyMoneroAccountTag(const std::string& tag, const std::string& label): m_tag(tag), m_label(label) { }
  PyMoneroAccountTag(const std::string& tag, const std::string& label, const std::vector<uint32_t>& account_indices): m_tag(tag), m_label(label), m_account_indices(account_indices) { }
...
public:
  ...
  PyMoneroQueryKeyParams(const std::string& key_type): m_key_type(key_type) { }
...
public:
  ...
  PyMoneroQueryOutputParams(const std::string& key_image): m_key_image(key_image) { }
...
public:
  ...
  PyMoneroGetAddressParams(uint32_t account_index): m_account_index(account_index) { }
  PyMoneroGetAddressParams(uint32_t account_index, const std::vector<uint32_t>& subaddress_indices): m_account_index(account_index), m_subaddress_indices(subaddress_indices) { }
...
public:
  ...
  PyMoneroGetAddressIndexParams(const std::string& address): m_address(address) { }
...
public:
  ...
  PyMoneroSplitIntegratedAddressParams(const std::string& integrated_address): m_integrated_address(integrated_address) { }
...
public:
  ...
  PyMoneroPrepareMultisigParams(bool enable_multisig_experimental = true): m_enable_multisig_experimental(enable_multisig_experimental) { }
...
public:
  ...
  PyMoneroImportMultisigHexParams(const std::vector<std::string>& multisig_hexes): m_multisig_hexes(multisig_hexes) { }
...
public:
  ...
  PyMoneroMakeMultisigParams(const std::vector<std::string>& multisig_hexes, const std::string& password): m_multisig_info(multisig_hexes), m_password(password) { }
  PyMoneroMakeMultisigParams(const std::vector<std::string>& multisig_hexes, int threshold, const std::string& password): m_multisig_info(multisig_hexes), m_threshold(threshold), m_password(password) { }
...
public:
  ...
  PyMoneroParsePaymentUriParams(const std::string& uri): m_uri(uri) { }
...
public:
  ...
  PyMoneroGetBalanceParams(bool all_accounts, bool strict = false): m_all_accounts(all_accounts), m_strict(strict) { }
...
public:
  ...
  PyMoneroCreateAccountParams(const std::string& tag = ""): m_tag(tag) { }
...
public:
  ...
  PyMoneroCloseWalletParams(bool save = false): m_save(save) { }
...
public:
  ...
  PyMoneroChangeWalletPasswordParams(const std::string& old_password, const std::string& new_password): m_old_password(old_password), m_new_password(new_password) { }
...
public:
  ...
  PyMoneroTxNotesParams(const std::vector<std::string>& tx_hashes): m_tx_hashes(tx_hashes) { }
  PyMoneroTxNotesParams(const std::vector<std::string>& tx_hashes, const std::vector<std::string>& notes): m_tx_hashes(tx_hashes), m_notes(notes) { }
...
public:
  ...
  PyMoneroAddressBookEntryParams(uint64_t index): m_index(index) { }
  PyMoneroAddressBookEntryParams(const std::vector<uint64_t>& entries): m_entries(entries) { }
  ...
  PyMoneroAddressBookEntryParams(const std::string& address, const std::string& description): m_address(address), m_description(description) { }
...
public:
  ...
  PyMoneroCheckTxKeyParams(const std::string &tx_hash): m_tx_hash(tx_hash) { }
...
public:
  ...
  PyMoneroSignDescribeTransferParams(const std::string &unsigned_txset) : m_unsigned_txset(unsigned_txset) { }
  PyMoneroSignDescribeTransferParams(const std::string &unsigned_txset, const std::string &multisig_txset) : m_unsigned_txset(unsigned_txset), m_multisig_txset(multisig_txset) { }
...
public:
  ...
  PyMoneroWalletRelayTxParams(const std::string &hex): m_hex(hex) { }
...
public:
  ...
  PyMoneroSweepParams(bool relay = false): m_relay(relay) { }
...
public:
  ...
  PyMoneroSubmitTransferParams(const std::string& signed_tx_hex): m_signed_tx_hex(signed_tx_hex) { }
...
public:
  ...
  PyMoneroImportExportOutputsParams(bool all): m_all(all) { }
  PyMoneroImportExportOutputsParams(const std::string& outputs_hex): m_outputs_hex(outputs_hex) { }
...
public:
  ...
  PyMoneroImportExportKeyImagesParams(const std::vector<std::shared_ptr<PyMoneroKeyImage>> &key_images): m_key_images(key_images) { }
  PyMoneroImportExportKeyImagesParams(bool all): m_all(all) { }
...
public:
  ...
  PyMoneroRefreshWalletParams(bool enable, uint64_t period): m_enable(enable), m_period(period) { }
  PyMoneroRefreshWalletParams(uint64_t start_height): m_start_height(start_height) { }
