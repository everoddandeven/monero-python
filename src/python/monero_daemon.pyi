...
class MoneroDaemon:
    ...
    def check_for_update(self) -> MoneroDaemonUpdateCheckResult:
        ...
        :returns MoneroDaemonUpdateCheckResult: the result of the update check.
        """
        ...
    ...
    def flush_tx_pool(self, hash: str) -> None:
        ...
        :param str hash: hash of the transaction to flush from tx pool.
        """
        ...
    ...
    def get_alt_block_hashes(self) -> list[str]:
        ...
        :returns list[str]: known block hashes which are not on the main chain.
        """
        ...
    ...
    def get_alt_chains(self) -> list[MoneroAltChain]:
        ...
        :returns list[MoneroAltChain]: alternative chains seen by the node.
        """
        ...
    ...
    def get_block_by_hash(self, hash: str) -> MoneroBlock:
        ...
        :returns MoneroBlock: the block with the given hash.
        """
        ...
    ...
    def get_block_by_height(self, height: int) -> MoneroBlock:
        ...
        :returns MoneroBlock: the block at the given height.
        """
        ...
    ...
    def get_block_hash(self, height: int) -> str:
        ...
        :returns str: the block's hash at the given height.
        """
        ...
    ...
    def get_block_header_by_hash(self, hash: str) -> MoneroBlockHeader:
        ...
        :returns MoneroBlockHeader: the block's header.
        """
        ...
    ...
    def get_block_headers_by_range(self, start_height: int, end_height: int) -> list[MoneroBlockHeader]:
        ...
        :returns list[MoneroBlockHeader]: block headers in the given range.
        """
        ...
    ...
    def get_blocks_by_height(self, heights: list[int]) -> list[MoneroBlock]:
        ...
        :returns list[MoneroBlock]: blocks at the given heights.
        """
        ...
    ...
    def get_blocks_by_range(self, start_height: typing.Optional[int], end_height: typing.Optional[int]) -> list[MoneroBlock]:
        ...
        :param int start_height: is the start height lower bound inclusive (optional).
        :param int end_height: is the end height upper bound inclusive (optional).
        :returns list[MoneroBlock]: blocks in the given height range.
        """
        ...
    ...
    def get_download_limit(self) -> int:
        ...
        :returns int: is the download bandwidth limit.
        """
        ...
    ...
    def get_fee_estimate(self, grace_blocks: int = 0) -> MoneroFeeEstimate:
        ...
        :param int grace_blocks: number of blocks we want the fee estimate to be valid for.
        :returns MoneroFeeEstimate: mining fee estimates per kB.
        """
        ...
    ...
    def get_hard_fork_info(self) -> MoneroHardForkInfo:
        ...
        :returns MoneroHardForkInfo: hard fork information.
        """
        ...
    ...
    def get_info(self) -> MoneroDaemonInfo:
        ...
        :returns MoneroDaemonInfo: general information about the node and network.
        """
        ...
    ...
    def get_key_image_spent_status(self, key_image: str) -> MoneroKeyImageSpentStatus:
        ...
        :returns MoneroKeyImageSpentStatus: the status of the key image.
        """
        ...
    ...
    def get_key_image_spent_statuses(self, key_images: list[str]) -> list[MoneroKeyImageSpentStatus]:
        ...
        :returns list[MoneroKeyImageSpentStatus]: the spent status for each key image.
        """
        ...
    ...
    def get_known_peers(self) -> list[MoneroPeer]:
        ...
        :returns list[MoneroPeer]: the daemon's known peers.
        """
        ...
    ...
    def get_last_block_header(self) -> MoneroBlockHeader:
        ...
        :returns MoneroBlockHeader: the last block's header.
        """
        ...
    ...
    def get_listeners(self) -> list[MoneroDaemonListener]:
        ...
        :returns list[MoneroDaemonListener]: the registered listeners.
        """
        ...
    ...
    def get_miner_tx_sum(self, height: int, num_blocks: int) -> MoneroMinerTxSum:
        ...
        :returns MoneroMinerTxSum: the sum emission and fees since the geneis block.
        """
        ...
    ...
    def get_output_histogram(self, amounts: list[int], min_count: int | None, max_count: int | None, is_unlocked: bool | None, recent_cutoff: int | None) -> list[MoneroOutputHistogramEntry]:
        ...
        :param list[int] amounts: are amounts of outputs to make the histogram with (atomic-units).
        :param Optional[int] min_count: filter amounts with at least this number of outputs.
        :param Optional[int] max_count: filter amounts with at most this number of outputs.
        :param Optional[bool] is_unlocked: makes a histogram with outputs with the specified lock state.
        :param Optional[int] recent_cutoff: exclude outputs from older than this timestamp.
        :returns list[MoneroOutputHistogramEntry]: output histogram entries meeting the parameters.
        """
        ...
    ...
    def get_peer_bans(self) -> list[MoneroBan]:
        ...
        :returns list[MoneroBan]: entries about banned peers.
        """
        ...
    ...
    def get_sync_info(self) -> MoneroDaemonSyncInfo:
        ...
        :returns MoneroDaemonSyncInfo: contains sync information.
        """
        ...
    ...
    def get_tx(self, tx_hash: str, prune: bool = False) -> MoneroTx | None:
        ...
        :returns MoneroTx | None: the transaction with the given hash or null if not found.
        """
        ...
    ...
    def get_tx_hex(self, tx_hash: str, prune: bool = False) -> str | None:
        ...
        :returns str | None: the tx hex with the given hash.
        """
        ...
    ...
    def get_tx_hexes(self, tx_hashes: list[str], prune: bool = False) -> list[str]:
        ...
        :returns list[str]: are the tx hexes.
        """
        ...
    ...
    def get_tx_pool(self) -> list[MoneroTx]:
        ...
        :returns list[MoneroTx]: transactions in the transaction pool.
        """
        ...
    ...
    def get_tx_pool_backlog(self) -> list[MoneroTxBacklogEntry]:
        ...
        :returns list[MoneroTxBacklogEntry]: transaction pool backlog entries.
        """
        ...
    ...
    def get_tx_pool_hashes(self) -> list[str]:
        ...
        :returns list[str]: hashes of transactions in the transaction pool.
        """
        ...
    ...
    def get_tx_pool_stats(self) -> MoneroTxPoolStats:
        ...
        :returns MoneroTxPoolStats: statistics about the transaction pool.
        """
        ...
    ...
    def get_txs(self, tx_hashes: list[str], prune: bool = False) -> list[MoneroTx]:
        ...
        :returns list[MoneroTx]: found transactions with the given hashes.
        """
        ...
    ...
    def get_upload_limit(self) -> int:
        ...
        :returns int: is the upload bandwidth limit.
        """
        ...
    ...
    def get_version(self) -> MoneroVersion:
        ...
        :returns MoneroVersion: the version of the daemon.
        """
        ...
    ...
    def prune_blockchain(self, check: bool) -> MoneroPruneResult:
        ...
        :returns MoneroPruneResult: the prune result.
        """
        ...
    ...
    def reset_download_limit(self) -> int:
        ...
        :returns int: the download bandwidth limit after resetting.
        """
        ...
    ...
    def set_download_limit(self, limit: int) -> int:
        ...
        :returns int: is the new download limit after setting.
        """
        ...
    ...
    def set_upload_limit(self, limit: int) -> int:
        ...
        :returns int: is the new upload limit after setting.
        """
        ...
    ...
    def submit_tx_hex(self, tx_hex: str, do_not_relay: bool = False) -> MoneroSubmitTxResult:
        ...
        :returns MoneroSubmitTxResult: the submission results.
        """
        ...
    ...
    def wait_for_next_block_header(self) -> MoneroBlockHeader:
        ...
        :returns MoneroBlockHeader: the header of the next block added to the chain.
        """
        ...
