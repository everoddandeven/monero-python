...
class MoneroKeyImage(SerializableStruct):
    ...
    def deserialize_key_images(key_images_json: str) -> list[MoneroKeyImage]:
        ...
        :param str key_images_json: JSON string with serialized key images.
        :returns list[MoneroKeyImage]: Deserialized key images.
        """
        ...
    ...
    def copy(self) -> MoneroKeyImage:
        ...
        :returns MoneroKeyImage: key image copy.
        """
        ...
    ...
    def merge(self, other: MoneroKeyImage) -> None:
        ...
        :param MoneroKeyImage other: other key image to merge with.
        """
        ...
