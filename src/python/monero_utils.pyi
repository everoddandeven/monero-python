...
class MoneroUtils:
    ...
    def get_blocks_from_outputs(outputs: list[MoneroOutputWallet]) -> list[MoneroBlock]:
        ...
        :returns list[MoneroBlock]: Distinct blocks obtained from outputs.
        """
        ...
    ...
    def get_blocks_from_transfers(transfers: list[MoneroTransfer]) -> list[MoneroBlock]:
        ...
        :returns list[MoneroBlock]: Distinct blocks obtained from transfers.
        """
        ...
    ...
    def get_ring_size() -> int:
        ...
        :returns int: network-enforced ring size.
        """
        ...
    ...
    def get_version() -> str:
        ...
        :returns str: the version of this monero-python library
        """
        ...
    ...
    def is_valid_language(language: str) -> bool:
        ...
        :returns bool: `True` if the language is valid, `False` otherwise.
        """
        ...
    ...
    def is_valid_payment_id(payment_id: str) -> bool:
        ...
        :returns bool: `True` if the payment id is valid, `False` otherwise.
        """
        ...
    ...
    def is_valid_private_spend_key(private_spend_key: str) -> bool:
        ...
        :returns bool: `True` if the private spend key is valid, `False` otherwise.
        """
        ...
    ...
    def is_valid_private_view_key(private_view_key: str) -> bool:
        ...
        :returns bool: `True` if the private view key is valid, `False` otherwise.
        """
        ...
    ...
    def is_valid_public_spend_key(public_spend_key: str) -> bool:
        ...
        :returns bool: `True` if the public spend key is valid, `False` otherwise.
        """
        ...
    ...
    def is_valid_public_view_key(public_view_key: str) -> bool:
        ...
        :param str public_view_key: is the public view key to validate.
        :returns bool: `True` if the public view key is valid, `False` otherwise.
        """
        ...
    ...
    def set_log_level(loglevel: int) -> None:
        ...
        :param int loglevel: the library's log level.
        """
        ...
    ...
    def xmr_to_atomic_units(amount_xmr: float) -> int:
        ...
        :returns int: amount in atomic units.
        """
        ...
