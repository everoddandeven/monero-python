...
class MoneroOutputQuery(MoneroOutputWallet):
    ...
    def deserialize_from_block(output_query_json: str) -> MoneroOutputQuery:
        ...
        :param str output_query_json: json query block.
        :returns MoneroOutputQuery: deserialized output query.
        """
        ...
    ...
    def copy(self) -> MoneroOutputQuery:
        ...
        :returns MoneroOutputQuery: output query copy.
        """
        ...
    ...
    def set_tx_query(self, tx_query: MoneroTxQuery | None, output_query: bool) -> None:
        ...
        :param Optional[MoneroTxQuery] tx_query: Tx query to set.
        :param bool output_query: If `True` sets outputs query in `tx_query`, otherwise inputs query.
        """
    ...
    def meets_criteria(self, output: MoneroOutputWallet, query_parent: bool = True) -> bool:
        ...
        :returns bool: `True` if `output` meets all the criteria defined in this query, `False` otherwise.
        """
        ...
